...
- Long term campaign tracking (see how many of those visits turned into signups, then paid accounts, etc.)
...
* Do to performance optimization IWonder must be used with an SQL style DB currently.
* Rails 3.1 or higher
...
If you want to configure this gem, add this to an initializer.
  ...
  IWonder.configuration do |c|
    ...
    c.only_log_hits_on_200 = false   # By default hits and new visitors won't be logged on anything but a 200. Your custom events will still be recorded.
  end
