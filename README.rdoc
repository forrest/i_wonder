...
This engine will use your standard application layout (unless you set a different layout in the configurations explained later). Which ever layout you use, you
must include a yield in the HTML header so the CSS and Javascript can be loaded. This engine also assumes that your layout will handle the <code>flash</code> notifications.


  <html>
    <head>
      
      ... your includes and header stuff here ...
